...
function displayDealerOrderItems(response){
	...
	$('#modal_body').html('');
	var protectType = null;
	var tableHead = '<table cellpadding="0" cellspacing="0" border="0" class=" table-responsive table table-striped table-bordered datatables" id="example">'+
    	'<thead><tr><th>Business Name</th><th>Product Category</th><th>Product Subcategory </th><th>Item Code</th><th>Item Description</th><th>Ordered Quantity</th><th>Price</th><th>Total Price</th><th>Delivered Quantity</th><th>Nullified Quantity</th><th>Pending Quantity</th><th>Deliver Quantity</th><th>Nullify Quantity</th><th ></th></tr>'+
    	"</thead><tbody></tbody></table>";
