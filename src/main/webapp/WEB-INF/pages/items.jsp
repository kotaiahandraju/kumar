					...
					<div class="panel-body">
						...
						<div class="col-md-4">
                    			<div class="form-group">
                    				...
                    				<div class="col-md-6">
                    	<form:select path="producttype" value="" class="form-control validate"  onchange="productNameFilter('');" >
                    		...
                    		<div class="col-md-4">
                    			<div class="form-group">
                    				...
                    				<div class="col-md-6">
                    	<form:select path="productname" value="" class="form-control validate"  onchange="removeBorder(this.id)" >
								    	<form:option value="">-- Select Product Name --</form:option>
<%-- 								    	<form:options items="${productName }"></form:options> --%>
							...
							<div class="col-md-6">
								<div class="form-group">
									<form:hidden path="id"/>
									<label for="focusedinput" class="col-md-4 control-label">Serial Number <span class="impColor">*</span></label>
									<div class="col-md-7">
										<form:input path="serialno" class="form-control validate" placeholder="Serial Number"/>
									</div>
                    			</div>
                    			<div class="form-group">
                    				<label for="focusedinput" class="col-md-4 control-label">Item Code <span class="impColor">*</span></label>
                    				<div class="col-md-7">
                    				<form:input path="itemcode" class="form-control validate" placeholder="Item Code"/>
                    				</div>
                    			</div>
                    			<div class="form-group">
...
function showTableData(response){
	...
	var tableHead = '<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">'+
    	'<thead><tr><th>Serial Number</th><th>Item Code</th><th>Description</th><th>Product Category</th><th>Product Sub Category</th><th>Status</th><th></th></tr>'+
