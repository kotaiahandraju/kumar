...
padding-top:8px;
            ...
            <div class="col-md-12 col-sm-12">
	                ...
	                <form:form  modelAttribute="orderLstForm"   class="form-horizontal" method="post" >
                    	...
                    	<div class="col-md-3">
                   		...
                   		<div class="col-md-4">
                   			<div class="form-group">
                   				<label for="focusedinput" class="col-md-5 control-label" style="padding-top:8px;">Branch: </label>
                   				<div class="col-md-6">
        ...
        <br>
            ...
            <div class="modal fade" id="orderListModal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		  <div class="modal-dialog"> 
		    <div class="modal-content  table-responsive">
		      <div class="modal-header">
		        <h4 class="modal-title" id="exampleModalLabel"><span id="dealer_name_str"></span></h4>
		       <span class="col-md-2" ><b>Dealer Name :</b></span><span class="col-md-2" id="dname">as</span> <span class="col-md-1" ><b>Order ID :</b></span> <span class="col-md-2" id="kumarid">as</span><span class="col-md-2" style="width:8.8%"><b>Order Date :</b></span>  <span class="col-md-2" id="korderdDate">as</span><br>
...
function displayDealerOrderItems(response){
	...
	var protectType = null;
	var tableHead = '<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">'+
    	'<thead><tr><th>Business Name</th><th>Product Category</th><th>Product Subcategory </th><th>Item Code</th><th>Item Description</th><th>Ordered Quantity</th><th>Price</th><th>Total Price</th><th>Delivered Quantity</th><th>Nullified Quantity</th><th>Pending Quantity</th></tr>'+
    	"</thead><tbody></tbody></table>";
